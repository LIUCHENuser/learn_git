...
<script>
	...
	export default{
		...
		methods:{
			ssaddfn(){
				if(this.s_name==""||this.prov==""||
				this.city==""||this.country==""||
				this.s_address==""||this.s_long==""||
				this.s_dime||this.s_account==""||
				this.s_pwd==""||this.leader==""||
				this.s_phone==""){
					alert("输入框不能为空")
				}else if(this.idzheng==require('../assets/idZheng.png')
				||this.idfan==require('../assets/idFan.png')){
					alert("请上传身份证图片")
				}else{
					ssadd({
						s_name:this.s_name,
