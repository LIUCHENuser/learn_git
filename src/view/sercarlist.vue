...
<div id="test1">
		...
		<!--<select name="">
			...
			<option v-for="(item,index) in city">{{item.name}}</option></select>
		<select name="">
			<option value="请选择" selected="selected"></option>
			<option v-for="(item1,index) in cityArray">{{item1.name}}</option></select>
		<select name="">
			<option value="请选择" selected="selected"></option>
...
>>>>>>> a5e2e715fb2864a315f8639aecd1e8c61b284fdd
		},
		mounted(){
